...
//   let result = text.substring(0,65) + " ...";
//   console.log(result);
...
// console.log(country.replace("bay", "Saol"));
...
// let users = [ "Saadat", "Fidan", "Togrul","Cavid", "Rovsen"];
...
// const myBoys = ["Togrul", "Cavid", "Rovsen"]

// const myChildren = myGirls.concat(myBoys);

// console.log(myChildren);

// users.splice(3,2,"Huseyn");


// let users = ["Saadat", "Fidan", "Togrul","Cavid", "Rovsen"];
// console.log(users);

// let result = users.slice(2,2,"Emil");
// console.log(users);

// const fruits = [ "Lemon", "Apple", "Banana", "Orange", "Mango"];
